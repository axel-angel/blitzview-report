...
% permutations
Although operations such as \verb|permutations| makes perfectly sense for the usual collections, these operations cannot be efficiently implemented without actually forcing the View.% without forcing the view
