...
We won't cover the details of the internal algorithms but suffices it to say the computation are dynamically dispatched among the processors according to the programmer policy (the context).
...
Moreover, in our design the programmer gains parallelism for free, this is fully integrated by the use of Scala Blitz whose algorithm can be configured (by importing some careful chosen \verb|implicit|s).
