...
We begin in section \ref{sec:previous} by showing what was done in the past, we explain what views are in \ref{sec:views}, we then describe our design in section \ref{sec:design}.
We continue by demonstrating how our Views are used in section \ref{sec:usability} and how they can be extended in section \ref{sec:ext}.
Finally we conclude in section \ref{sec:conclusion} with the source code in appendix \ref{sec:source}.
...
We will develop these aspects in section \ref{sec:views} and how we approached differently the problem.
%which section?
