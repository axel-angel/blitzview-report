...
The first type augments specific type shape and is referred as {\it implicit-extensions}, while the second type, where we construct a class based on the representation, is referred as {\it implicit-evidence} (like a proof).
...
In this case \verb|B| has a special shape: B = \verb|BlitzView[C]|, and the implicit-extension is triggered when the user calls \verb|flatten|.
